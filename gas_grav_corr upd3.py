...
if co2_comp <= 0.12 or n2_comp <= 0.03 or h2s_comp <= 0:
    ...
    round(gas_gravity, 4)
    Joshua = round(gas_gravity, 4)
    print('The corrected gas gravity is', Joshua)
...
print('The hydrocarbon pseudo pressure is {0:.1f} psia'.format(P_pc))
print('The hydrocarbon pseuso Temperature is {0:.1f} deg Rankine'.format(T_pc))
